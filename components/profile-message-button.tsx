...
export function ProfileMessageButton({ targetUsername }: { targetUsername: string }) {
  ...
  return (
    <>
      <button
        ...
        className="mt-4 border-2 border-foreground px-3 py-1.5 text-sm font-medium hover:bg-foreground hover:text-background transition-colors inline-flex items-center gap-2"
      >
