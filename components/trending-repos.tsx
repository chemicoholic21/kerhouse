  ...
  return (
    <section>
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-bold">Trending {viewMode === "repos" ? "Repositories" : "Issues"}</h2>
            ...
            >
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-bold text-sm break-all group-hover:underline">{repo.name}</div>
                  <span className="text-xs capitalize text-muted-foreground">{repo.difficulty}</span>
                </div>
              </div>
