  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="layout-container py-8 max-w-2xl">
        <p className="text-xs font-bold uppercase tracking-wide text-muted-foreground mb-2">Prototype</p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0">
              ...
              <div className="flex flex-wrap gap-x-4 gap-y-1 mt-3 text-sm text-muted-foreground">
                ...
                <span>Primary stack: {p.primaryLanguage}</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="border-2 border-dashed border-foreground/70 p-5 mb-6">
          ...
          <p className="text-sm tabular-nums mt-1">{p.weeklyScore.toLocaleString("en-US", { maximumFractionDigits: 1 })} impact score</p>
